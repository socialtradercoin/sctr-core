                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzSCTRPathCustom = GetArg("-zsctrbackuppath", "");
    ...
    if(!strzSCTRPathCustom.empty()) {
        ui->wallet_customzsctrbackuppath->setText(QString::fromStdString(strzSCTRPathCustom));
        ui->wallet_customzsctrbackuppath_label->setVisible(true);
        ui->wallet_customzsctrbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzSCTRPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the SCTR RPC console.") + "<br>" +
