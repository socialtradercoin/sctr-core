...
/* Sctr GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "SCTR"
#define QAPP_ORG_DOMAIN "sctr.org"
#define QAPP_APP_NAME_DEFAULT "SCTR-Qt"
#define QAPP_APP_NAME_TESTNET "SCTR-Qt-testnet"
