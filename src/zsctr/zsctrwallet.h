...
#ifndef SCTR_ZSCTRWALLET_H
#define SCTR_ZSCTRWALLET_H
...
public:
    CzSCTRWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZSCTR(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZSCTR(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
