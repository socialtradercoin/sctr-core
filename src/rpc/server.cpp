...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* SCTR features */
        {"sctr", "masternode", &masternode, true, true, false},
        {"sctr", "listmasternodes", &listmasternodes, true, true, false},
        {"sctr", "getmasternodecount", &getmasternodecount, true, true, false},
        {"sctr", "masternodeconnect", &masternodeconnect, true, true, false},
        {"sctr", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"sctr", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"sctr", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"sctr", "masternodecurrent", &masternodecurrent, true, true, false},
        {"sctr", "masternodedebug", &masternodedebug, true, true, false},
        {"sctr", "startmasternode", &startmasternode, true, true, false},
        {"sctr", "createmasternodekey", &createmasternodekey, true, true, false},
        {"sctr", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"sctr", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"sctr", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"sctr", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"sctr", "getmasternodescores", &getmasternodescores, true, true, false},
        {"sctr", "mnbudget", &mnbudget, true, true, false},
        {"sctr", "preparebudget", &preparebudget, true, true, false},
        {"sctr", "submitbudget", &submitbudget, true, true, false},
        {"sctr", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"sctr", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"sctr", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"sctr", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"sctr", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"sctr", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"sctr", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"sctr", "checkbudgets", &checkbudgets, true, true, false},
        {"sctr", "mnsync", &mnsync, true, true, false},
        {"sctr", "spork", &spork, true, true, false},
        {"sctr", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzsctrseed", &getzsctrseed, false, false, true},
        {"zerocoin", "setzsctrseed", &setzsctrseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzsctr", &searchdzsctr, false, false, true},
        {"zerocoin", "dzsctrstate", &dzsctrstate, false, false, true},
...
{
    return "> sctr-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:19321/\n";
}
