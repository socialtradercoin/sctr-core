...
extern UniValue setzsctrseed(const UniValue& params, bool fHelp);
extern UniValue getzsctrseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzsctr(const UniValue& params, bool fHelp);
extern UniValue dzsctrstate(const UniValue& params, bool fHelp);
