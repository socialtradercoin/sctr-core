...
This mechanism has been integrated into Bitcore-Node-SCTR which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/socialtradernode/insight-api-sctr#web-socket-api](https://github.com/socialtradernode/insight-api-sctr#web-socket-api) 
* API: [https://github.com/socialtradernode/insight-api-sctr#swifttx-transactions](https://github.com/socialtradernode/insight-api-sctr#swifttx-transactions) 
...
By default, the SCTR Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the SCTR Core daemon:
