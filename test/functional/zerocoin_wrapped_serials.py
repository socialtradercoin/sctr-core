...
from fake_stake.base_test import SCTR_FakeStakeTest

class zSCTRwrappedSerialsTest(SCTR_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zSCTRs..." % DENOM_TO_USE)
