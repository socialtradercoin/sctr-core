Contributing to SCTR Core
============================

The SCTR Core project operates an open contributor model where anyone is
...
The following applies to code changes to the SCTR Core project, and is not to be
confused with overall SCTR Network Protocol consensus changes.

Whether a pull request is merged into SCTR Core rests with the project merge
...
Patches that change SCTR consensus rules are considerably more involved than
...
Where a patch set proposes to change the SCTR consensus, it must have been
...
The project leader is the release manager for each SCTR Core release.
