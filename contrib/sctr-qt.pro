...
RESOURCES += src/qt/sctr.qrc src/qt/sctr_locale.qrc

TRANSLATIONS += src/qt/locale/sctr_bg.ts \
                src/qt/locale/sctr_de.ts \
                src/qt/locale/sctr_en.ts \
                src/qt/locale/sctr_es.ts \
                src/qt/locale/sctr_fi.ts \
                src/qt/locale/sctr_fr.ts \
                src/qt/locale/sctr_it.ts \
                src/qt/locale/sctr_ja.ts \
                src/qt/locale/sctr_pl.ts \
                src/qt/locale/sctr_pt.ts \
                src/qt/locale/sctr_ru.ts \
                src/qt/locale/sctr_sk.ts \
                src/qt/locale/sctr_sv.ts \
                src/qt/locale/sctr_vi.ts \
                src/qt/locale/sctr_zh_CN.ts \
                src/qt/locale/sctr_zh_TW.ts
